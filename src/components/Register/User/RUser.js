  ...
  return (
    <div className="registration-container">
      <form className="registration-form" onSubmit={handleSubmit}>
        <p></p>
        <h1 class="h11">User Registration</h1>
        ...
        <div className="label-row">
          <label class="label2" htmlFor="mobile">
            Mobile Number:
          </label>
          <input
            class="input2"
        ...
        <div className="label-row">
          <label class="label2" htmlFor="email">
            Email:
          </label>
          <input
            class="input2"
        ...
        <div className="label-row">
          <label class="label2" htmlFor="address">
            Address:
          </label>
          <textarea
            class="input2"
        ...
        {/* Profile Information */}
        <h2 class="h22">Profile Information</h2>
        <div className="label-row">
          <label class="label2" htmlFor="username">
            Username:
          </label>
          <input
            class="input2"
        ...
        <div className="label-row">
          <label class="label2" htmlFor="customerId">
            Customer ID:
          </label>
          <input
            class="input2"
